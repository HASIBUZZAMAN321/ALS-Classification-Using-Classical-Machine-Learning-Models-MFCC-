...
class Waveform:
    ...
    def __init__(self, path=None, signal=None, sample_rate=44100):
        ...
        if path is not None:
            self._waveform, _ = librosa.load(path)
        else:
    ...
    def spectral_slope(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_slope(magnitude_spectrum, self.sample_rate)
    ...
    def spectral_flux(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_flux(magnitude_spectrum, self.sample_rate)
    ...
    def spectral_centroid(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_centroid(magnitude_spectrum, self.sample_rate)
    ...
    def spectral_spread(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_spread(magnitude_spectrum, self.sample_rate)
    ...
    def spectral_skewness(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_skewness(magnitude_spectrum, self.sample_rate)
    ...
    def spectral_kurtosis(self, n_fft_seconds=0.04, hop_length_seconds=0.01):
        ...
        return get_spectral_kurtosis(magnitude_spectrum, self.sample_rate)
    ...
    def hnr(self):
        ...
        """
        return get_harmonics_to_noise_ratio(self.waveform, self.sample_rate)
    ...
    def dfa(self, window_lengths=[64, 128, 256, 512, 1024, 2048, 4096]):
        ...
        """
        return get_dfa(self.waveform, window_lengths)
    ...
    def formants(self):
        ...
        """
        formants_dict = get_formants(self.waveform, self.sample_rate)
